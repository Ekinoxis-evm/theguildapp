...
<CardGroup cols={2}>
  ...
  <Card title="View on GitHub" icon="arrow-up-right-from-square" href="https://github.com/resend/resend-skills">    See the full source code and documentation.  </CardGroup>
