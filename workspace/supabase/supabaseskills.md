...
You can also install the agent skills together with the Supabase MCP server using the [Supabase Plugin for AI Coding Agents](https://supabase.com/docs/guides/getting-started/plugins) for a combined one-step setup.
