...
const en = {
  ...
  dashboard: {
    ...
    sections: {
      ...
      events: { title: "My events", blurb: "Guild activations you've joined." },
      profile: { title: "Profile", blurb: "Personal info and My Style photos." },
      myBarber: { title: "My barber business", blurb: "Your services, certifications, and bookings." },
...
const es: Dict = {
  ...
  dashboard: {
    ...
    sections: {
      ...
      events: { title: "Mis eventos", blurb: "Activaciones de The Guild en las que participas." },
      profile: { title: "Perfil", blurb: "Datos personales y fotos de Mi Estilo." },
      myBarber: { title: "Mi negocio de barbero", blurb: "Tus servicios, certificaciones y reservas." },
